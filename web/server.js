...
app.get('/medical_Doc', async (req, res) => {
    ...
    const data = await fetch("http://nginx:8080/medicalrecord/3/MedicalDoc")

    const x = await data.json()

    console.log(x)
    res.render('MedicalDocView/index.ejs')
}
)
/*******************************************/
...
app.post('/*/predict', async (req, res) => {
    ...
    uri =url + "verify";
    console.log(uri)
    var response = await fetch("http://nginx:8080/diseaseprediction", { method: "POST", body })
